...
This project is indexed by GitNexus as **bonfire-cli** (261 symbols, 806 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
